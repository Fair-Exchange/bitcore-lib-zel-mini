...
bitcore.versionGuard = function(version) {
  if (version !== undefined) {
    var message = 'More than one instance of bitcore-lib-zel-mini found. ' +
      'Please make sure to require bitcore-lib-zel-mini and check that submodules do' +
      ' not also include their own bitcore-lib-zel-mini dependency.';
